...
class VAP(nn.Module):
    def __init__(
        ...
        if self.video_dim > 0:
            ...
            # Audio-conditioned gate after self-attention, before cross-attention
    ...
    def forward(
        ...
        # 2. Video self-attention + bidirectional audio-video cross-attention
        if self.video_dim > 0:
            ...
            # Gate after self-attention, before cross-attention
